...
var ref  = Bot.getProperty("ndjdbfhfbfb")


  Api.editMessageText({
  message_id: request.message.message_id,
  text: "Unfortunately this feature is temporarily shut down. It will be back.\nWays to earn XCP⚡:\n•Bet using tickets or XCP⚡\n•Daily Bonus",
  disable_web_page_preview: true,
  reply_markup: {inline_keyboard: [[{text: "Back🔙", callback_data: "/levels"}]]}
})
