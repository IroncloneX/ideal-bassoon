...
var ryu = Libs.Random.randomInt(1, 3)
var trt = Bot.getProperty("for "+ryu)
 User.setProperty("format", trt, "string")
...
var formaat =  User.getProperty("format")
